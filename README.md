...
- **Manajemen Master Aset**: Tambah, edit, hapus, dan filter data aset masjid & cabang.
- **Generator Label & QR Code**: Cetak label barcode/QR code untuk penempelan fisik barang.
- **Kalkulator Depresiasi**: Perhitungan nilai susut aset otomatis (Metode Garis Lurus).
- **Laporan & Export**: Export data ke PDF dan Excel.
